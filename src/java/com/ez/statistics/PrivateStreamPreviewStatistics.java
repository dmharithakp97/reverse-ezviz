...
public class PrivateStreamPreviewStatistics
extends BasePreviewStatistics {
    public String systemName = "app_video_preview_vtdu";
    public String vtmIP;
    public int vtmPort;
    public int t2;
    public int r2;
    ...
    public int proxyTime = -1;
    public int vtduCache = 0;
    public int firstR = 0;
    public long timeStamp = 0L;
    public long inSubPreview_t = 0L;
    public long apiStart_t = 0L;
    public long apiBack_t = 0L;
